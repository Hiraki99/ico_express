...
describe('User Model', () => {
  it('should create a new user', (done) => {
    const UserMock = sinon.mock(new User({ email: 'test@gmail.com', password: SC.AdminType.ROOT }));
  ...
  it('should not create a user with the unique email', (done) => {
    const UserMock = sinon.mock(User({ email: 'test@gmail.com', password: SC.AdminType.ROOT }));
    const user = UserMock.object;
    const expectedError = {
      name: 'MongoError',
      code: 11000
