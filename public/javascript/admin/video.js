        ...
        success: function(json) {
            ...
            if (!json.error) {
                ...
                for (var i=0 ; i< json.length;i++){
                    ...
                    strVar += "<td>"+data.video_title+"<\/td> <td>"+data.video_link+"<\/td>";
