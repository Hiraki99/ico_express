...
document.querySelector('.sweet-text')
    .onclick = function () {
        swal("Hey, Here's a message !!", "It's pretty, isn't it?")
    };
document.querySelector('.sweet-success')
    .onclick = function () {
        swal("Hey, Good job !!", "You clicked the button !!", "success")
    };
document.querySelector('.sweet-confirm')
    .onclick = function () {
        swal({
...
document.querySelector('.sweet-image-message')
    .onclick = function () {
        swal({
            title: "Sweet !!",
...
document.querySelector('.sweet-html')
    .onclick = function () {
        swal({
            title: "Sweet !!",
...
document.querySelector('.sweet-auto')
    .onclick = function () {
        swal({
...
document.querySelector('.sweet-prompt')
    .onclick = function () {
        swal({
...
document.querySelector('.sweet-ajax')
    .onclick = function () {
        swal({
